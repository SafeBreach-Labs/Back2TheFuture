...
static const SERVER_ROUTINE DefaultIfName_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Proc0_LsarClose,
    (SERVER_ROUTINE)Proc1_CredrRename,
    (SERVER_ROUTINE)Proc2_LsarEnumeratePrivileges,
    (SERVER_ROUTINE)Proc3_LsarQuerySecurityObject,
    (SERVER_ROUTINE)Proc4_LsarSetSecurityObject,
    (SERVER_ROUTINE)Proc5_LsaITestCall,
    (SERVER_ROUTINE)Proc6_LsarOpenPolicyRPC,
    (SERVER_ROUTINE)Proc7_LsarQueryInformationPolicy,
    (SERVER_ROUTINE)Proc8_LsarSetInformationPolicy,
    (SERVER_ROUTINE)Proc9_LsaITestCall,
    (SERVER_ROUTINE)Proc10_LsarCreateAccount,
    (SERVER_ROUTINE)Proc11_LsarEnumerateAccounts,
    (SERVER_ROUTINE)Proc12_LsarCreateTrustedDomain,
    (SERVER_ROUTINE)Proc13_LsarEnumerateTrustedDomains,
    (SERVER_ROUTINE)Proc14_LsarLookupNames,
    (SERVER_ROUTINE)Proc15_LsarLookupSids,
    (SERVER_ROUTINE)Proc16_LsarCreateSecret,
    (SERVER_ROUTINE)Proc17_LsarOpenAccount,
    (SERVER_ROUTINE)Proc18_LsarEnumeratePrivilegesAccount,
    (SERVER_ROUTINE)Proc19_LsarAddPrivilegesToAccount,
    (SERVER_ROUTINE)Proc20_LsarRemovePrivilegesFromAccount,
    (SERVER_ROUTINE)Proc21_LsarGetQuotasForAccount,
    (SERVER_ROUTINE)Proc22_LsaAllocateSharedMemory,
    (SERVER_ROUTINE)Proc23_LsarGetSystemAccessAccount,
    (SERVER_ROUTINE)Proc24_LsarSetSystemAccessAccount,
    (SERVER_ROUTINE)Proc25_LsarOpenTrustedDomain,
    (SERVER_ROUTINE)Proc26_LsarQueryInfoTrustedDomain,
    (SERVER_ROUTINE)Proc27_LsarSetInformationTrustedDomain,
    (SERVER_ROUTINE)Proc28_LsarOpenSecret,
    (SERVER_ROUTINE)Proc29_LsarSetSecret,
    (SERVER_ROUTINE)Proc30_LsarQuerySecret,
    (SERVER_ROUTINE)Proc31_LsarLookupPrivilegeValue,
    (SERVER_ROUTINE)Proc32_LsarLookupPrivilegeName,
    (SERVER_ROUTINE)Proc33_LsarLookupPrivilegeDisplayName,
    (SERVER_ROUTINE)Proc34_LsarDeleteObject,
    (SERVER_ROUTINE)Proc35_LsarEnumerateAccountsWithUserRight,
    (SERVER_ROUTINE)Proc36_LsarEnumerateAccountRights,
    (SERVER_ROUTINE)Proc37_LsarAddAccountRights,
    (SERVER_ROUTINE)Proc38_LsarRemoveAccountRights,
    (SERVER_ROUTINE)Proc39_LsarQueryTrustedDomainInfo,
    (SERVER_ROUTINE)Proc40_LsarSetTrustedDomainInfo,
    (SERVER_ROUTINE)Proc41_LsarDeleteTrustedDomain,
    (SERVER_ROUTINE)Proc42_LsarStorePrivateData,
    (SERVER_ROUTINE)Proc43_LsarRetrievePrivateData,
    (SERVER_ROUTINE)Proc44_LsarOpenPolicy2,
    (SERVER_ROUTINE)Proc45_LsarGetUserName,
    (SERVER_ROUTINE)Proc46_LsarQueryInformationPolicy2,
    (SERVER_ROUTINE)Proc47_LsarSetInformationPolicy2,
    (SERVER_ROUTINE)Proc48_LsarQueryTrustedDomainInfoByName,
    (SERVER_ROUTINE)Proc49_LsarSetTrustedDomainInfoByName,
    (SERVER_ROUTINE)Proc50_LsarEnumerateTrustedDomainsEx,
    (SERVER_ROUTINE)Proc51_LsarCreateTrustedDomainEx,
    (SERVER_ROUTINE)Proc52_LsaITestCall,
    (SERVER_ROUTINE)Proc53_LsarQueryDomainInformationPolicy,
    (SERVER_ROUTINE)Proc54_LsarSetDomainInformationPolicy,
    (SERVER_ROUTINE)Proc55_LsarOpenTrustedDomainByName,
    (SERVER_ROUTINE)Proc56_LsaITestCall,
    (SERVER_ROUTINE)Proc57_LsarLookupSids2,
    (SERVER_ROUTINE)Proc58_LsarLookupNames2,
    (SERVER_ROUTINE)Proc59_LsarCreateTrustedDomainEx2,
    (SERVER_ROUTINE)Proc60_CredrWrite,
    (SERVER_ROUTINE)Proc61_CredrRead,
    (SERVER_ROUTINE)Proc62_CredrEnumerate,
    (SERVER_ROUTINE)Proc63_CredrWriteDomainCredentials,
    (SERVER_ROUTINE)Proc64_CredrReadDomainCredentials,
    (SERVER_ROUTINE)Proc65_CredrDelete,
    (SERVER_ROUTINE)Proc66_CredrGetTargetInfo,
    (SERVER_ROUTINE)Proc67_CredrProfileLoaded,
    (SERVER_ROUTINE)Proc68_LsarLookupNames3,
    (SERVER_ROUTINE)Proc69_CredrGetSessionTypes,
    (SERVER_ROUTINE)Proc70_LsarRegisterAuditEvent,
    (SERVER_ROUTINE)Proc71_LsarGenAuditEvent,
    (SERVER_ROUTINE)Proc72_LsarUnregisterAuditEvent,
    (SERVER_ROUTINE)Proc73_LsarQueryForestTrustInformation,
    (SERVER_ROUTINE)Proc74_LsarSetForestTrustInformation,
    (SERVER_ROUTINE)Proc75_CredrRename,
    (SERVER_ROUTINE)Proc76_LsarLookupSids3,
    (SERVER_ROUTINE)Proc77_LsarLookupNames4,
    (SERVER_ROUTINE)Proc78_LsarOpenPolicySce,
    (SERVER_ROUTINE)Proc79_LsarAdtRegisterSecurityEventSource,
    (SERVER_ROUTINE)Proc80_LsarAdtUnregisterSecurityEventSource,
    (SERVER_ROUTINE)Proc81_LsarAdtReportSecurityEvent,
    (SERVER_ROUTINE)Proc82_CredrFindBestCredential,
    (SERVER_ROUTINE)Proc83_LsarSetAuditPolicy,
    (SERVER_ROUTINE)Proc84_LsarQueryAuditPolicy,
    (SERVER_ROUTINE)Proc85_LsarEnumerateAuditPolicy,
    (SERVER_ROUTINE)Proc86_LsarEnumerateAuditCategories,
    (SERVER_ROUTINE)Proc87_LsarEnumerateAuditSubCategories,
    (SERVER_ROUTINE)Proc88_LsarLookupAuditCategoryName,
    (SERVER_ROUTINE)Proc89_LsarLookupAuditSubCategoryName,
    (SERVER_ROUTINE)Proc90_LsarSetAuditSecurity,
    (SERVER_ROUTINE)Proc91_LsarQueryAuditSecurity,
    (SERVER_ROUTINE)Proc92_CredrReadByTokenHandle,
    (SERVER_ROUTINE)Proc93_CredrRestoreCredentials,
    (SERVER_ROUTINE)Proc94_CredrBackupCredentials,
    (SERVER_ROUTINE)Proc95_LsarManageSidNameMapping,
    (SERVER_ROUTINE)Proc96_CredrProfileUnloaded,
    (SERVER_ROUTINE)Proc97_CredrRename,
    (SERVER_ROUTINE)Proc98_CredrRename,
    (SERVER_ROUTINE)Proc99_CredrRename,
    (SERVER_ROUTINE)Proc100_CredrRename,
    (SERVER_ROUTINE)Proc101_CredrRename,
    (SERVER_ROUTINE)Proc102_LsarEfsGetSmartcardCredentials,
    (SERVER_ROUTINE)Proc103_LsarAuditSetGlobalSacl,
    (SERVER_ROUTINE)Proc104_LsarAuditQueryGlobalSacl,
    (SERVER_ROUTINE)Proc105_CredrProfileLoadedEx,
    (SERVER_ROUTINE)Proc106_LsarInteractiveSessionIsLoggedOff,
    (SERVER_ROUTINE)Proc107_LsarConfigureAutoLogonCredentials,
    (SERVER_ROUTINE)Proc108_LsarGetDeviceRegistrationInfo
    };
